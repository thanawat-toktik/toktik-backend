"""
Django settings for toktik_backend project.
...
ROOT_URLCONF = "toktik_backend.urls"
...
CACHES = {
    "default": {
        ...
        "LOCATION": f"redis://{os.getenv('REDIS_HOSTNAME', 'localhost')}:{os.getenv('REDIS_PORT', '6381')}/9",
    }
}
